...
def load_srl_data():
    with open('C:/test_github/04mean/model/srl.train.korean.conll','r',encoding = 'utf-8') as f:
        d = f.readlines()    
#     trn = raw2tagseq(d)
    trn = conll2tagseq(d)
    with open('C:/test_github/04mean/model/srl.test.korean.conll','r',encoding = 'utf-8') as f:
        d = f.readlines()    
#     tst = raw2tagseq(d)
    tst = conll2tagseq(d)
