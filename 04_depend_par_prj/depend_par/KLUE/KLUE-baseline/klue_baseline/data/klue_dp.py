...
class KlueDPProcessor(DataProcessor):
    ...
    origin_train_file_name = "NXDP1902103231_train.tsv"
    origin_dev_file_name = "NXDP1902103231_dev.tsv"
    origin_test_file_name = "NXDP1902103231_test.tsv"
        ...
        for example in examples:
            if SENT_ID != example.sent_id:
                ...
                for token, head, dep, pos in zip(token_list, head_list, dep_list, pos_list):
                    ...
                    # except as e:
                        # print(f"tmp_idx > {tmp_idx} {token} {head}")
                        # print(f"dep > {dep}")
                        # print(f"pos > {pos}")
